    ...
    <section id="content">
        ...
        <?php if ($detect_OS == "OSX" || USE_DIVX): ?>
            ...
            <object classid="clsid:67DABFBF-D0AB-41fa-9C46-CC0F21721616" width="<?php echo DIVX_WIDTH ?>" height="<?php echo DIVX_HEIGTH ?>" codebase="http://go.divx.com/plugin/DivXBrowserPlugin.cab">
                ...
                <embed type="video/divx" src="<?php echo DOWNLOAD_LINK.addslashes($filePath); ?>" custommode="none" width="<?php echo DIVX_WIDTH ?>" height="<?php echo DIVX_HEIGTH ?>" autoPlay="<?php echo DIVX_AUTOPLAY ?>" pluginspage="http://go.divx.com/plugin/download/"></embed>
            </object>
            <!-- / DivX -->
